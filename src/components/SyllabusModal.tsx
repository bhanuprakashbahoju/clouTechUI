    ...
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col p-0 gap-0">
                ...
                {/* Fixed Footer CTA */}
                <div className="p-6 border-t border-gray-200 bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-10">
                    <EnrollmentModal course={course}>
                        <button className={`w-full bg-gradient-to-r ${course.gradient} text-white py-3 rounded-xl font-bold text-lg hover:shadow-lg transition-all duration-300 transform active:scale-[0.99]`}>
                            Enroll Now
                        </button>
                    </EnrollmentModal>
                </div>
